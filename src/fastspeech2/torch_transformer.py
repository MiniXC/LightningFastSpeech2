# SOURCE: https://github.com/pytorch/pytorch/blob/dc557b94ec98e7651ac14975851ff8015188114a/torch/nn/modules/transformer.py
# Copied to add LayerDrop to Encoder and Decoder layers
...
class TransformerEncoder(Module):
    ...
    def __init__(self, encoder_layer, num_layers, norm=None, enable_nested_tensor=True, mask_check=True, layer_drop_prob=0.0):
    ...
    def forward(self, src: Tensor, mask: Optional[Tensor] = None, src_key_padding_mask: Optional[Tensor] = None, additional_src=None) -> Tensor:
        ...
        ps = ps < self.layer_drop_prob
        if all(ps):
            # set a random layer to not be dropped
            ps[np.random.randint(len(self.layers))] = False
...
class TransformerDecoder(Module):
    ...
    def __init__(self, decoder_layer, num_layers, norm=None, layer_drop_prob=0.0):
